...
const Sobre = () => (
    <View style={styles.container}>
        <Image style={{resizeMode: 'stretch', justifyContent: 'center', alignItems: 'center',}}  source={{ uri: 'http://descarteverde.ml/assets/img/logo-white.png'}} width={300} height={58} />
        ...
        <View style={[styles.cardContainer, { padding: metrics.basePadding / 2 }]}>
            <Text style={styles.description}>
