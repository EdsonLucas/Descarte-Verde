...
const Sobre = () => (
    <View style={styles.container}>
        <View style={styles.imageContainer}>
            <ResponsiveImage style={{resizeMode: 'stretch'}}  source={{ uri: 'http://descarteverde.ml/assets/img/logo-white.png'}} width={360} height={69} />
        </View>
        
        <View style={styles.cardContainer}>
            <View style={styles.imageCardContainer}>
                <ResponsiveImage style={{resizeMode: 'stretch'}}  source={require('images/green-idea.png')} width={81} height={117} />
            </View>
