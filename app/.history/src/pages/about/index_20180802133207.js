...
const Sobre = () => (
    <View style={styles.container}>
        <View style={styles.imageContainer}>
            <ResponsiveImage style={{resizeMode: 'stretch'}}  source={{uri: 'http://descarteverde.ml/assets/img/logo.png'}} initWidth={360} initHeight={70} />
        </View>
...
Sobre.navigationOptions = {
    ...
    tabBarIcon: ({ tintColor }) => <Ionicons name="md-information-circle" size={(Platform.OS === 'ios') ? 18 : 22} color={tintColor} />
}
