...
const Sobre = () => (
    <LinearGradient start={{x: 0, y: 0.25}} end={{x: 0, y: 1}} colors={['#00c398', '#6ed39b','#cceeb0']} style={styles.container}>
        ...
        <View style={{ flex: 0.2, flexDirection: 'row', alignItems: 'flex-end', justifyContent: 'center', backgroundColor: 'red'}}>
        ...
        <View style={{ flex: 0.8, flexDirection: 'column', justifyContent: 'center', backgroundColor: 'blue',}}>
