...
import { MaterialCommunityIcons, Ionicons, Feather } from 'icons';
...
Sobre.navigationOptions = {
    header: null,
    swipeEnabled: false,
    tabBarIcon: ({ tintColor }) => <MaterialCommunityIcons name="sliders" size={(Platform.OS === 'ios') ? 18 : 24} color={tintColor} />
}
