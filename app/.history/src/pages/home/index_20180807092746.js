                ...
                <LinearGradient start={{x: 0, y: 0.25}} end={{x: 0, y: 1}} colors={['#00c398', '#6ed39b','#cceeb0']} style={styles.form}>
                    ...
                    <View style={styles.subForm}>
                        <TouchableOpacity style={styles.button} onPress={ () => {} }>
                            <Ionicons name="ios-paper" size={(Platform.OS === 'ios') ? 18 : 45} color={colors.white} />
                            <Text style={styles.buttonText}>Papel</Text>
                        </TouchableOpacity>

                        <TouchableOpacity style={styles.button} onPress={ () => {} }>
                            <MaterialCommunityIcons name="recycle" size={(Platform.OS === 'ios') ? 18 : 45} color={colors.white} />
                    ...
                    <View style={styles.subForm}>
                        <TouchableOpacity style={styles.button} onPress={ () => {} }>
                            <MaterialCommunityIcons name="bottle-wine" size={(Platform.OS === 'ios') ? 18 : 45} color={colors.white} />
