        ...
        return (
            <View style={styles.container}>
                ...
                <View style={styles.imageContainer}>
                    <ResponsiveImage style={{resizeMode: 'stretch'}}  source={require('images/logo.jpg')} initWidth={321} initHeight={63} />
                ...
                <LinearGradient start={{x: 0, y: 0.25}} end={{x: 0, y: 1}} colors={['#00c398', '#6ed39b','#cceeb0']} style={styles.form}>
                    ...
                    <View style={styles.subForm}>
                        <ImageBackground style={styles.button} source={require('images/banner.png')}>
                        ...
                        <ImageBackground style={styles.button} source={require('images/banner.jpg')}>
                            <TouchableOpacity style={styles.button} onPress={ () => {} }>
