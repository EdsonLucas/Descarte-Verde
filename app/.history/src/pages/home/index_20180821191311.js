            ...
            <View style={styles.container}>
              ...
              <LinearGradient start={{x: 0, y: 0.25}} end={{x: 0, y: 1}} colors={['#00c398', '#6ed39b','#cceeb0']} style={styles.form}>
                ...
                <View style={styles.subForm}>
                      <TouchableOpacity style={styles.button} onPress={ () => this.props.navigation.navigate('Map') }>
                          <ResponsiveImage style={{resizeMode: 'stretch'}} source={require('images/icon-papel.png')} initWidth={40} initHeight={40} />
                ...
                <View style={styles.subForm}>
                      <TouchableOpacity style={styles.button} onPress={ () => this.props.navigation.navigate('Map') }>
                          <ResponsiveImage style={{resizeMode: 'stretch'}} source={require('images/icon-vidro.png')} initWidth={40} initHeight={40} />
