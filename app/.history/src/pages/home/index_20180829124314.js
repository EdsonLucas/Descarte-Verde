            ...
            <View style={styles.container}>
              ...
              <LinearGradient start={{x: 0, y: 0.25}} end={{x: 0, y: 1}} colors={['#00c398', '#6ed39b','#cceeb0']} style={styles.form}>
                ...
                <View style={styles.subForm}>
                      <TouchableOpacity style={styles.button} onPress={ () => this.props.navigation.navigate('Map', { 'file': 'locations2.json' }) }>
                          <ResponsiveImage style={{resizeMode: 'stretch'}} source={require('images/icon-papel.png')} initWidth={38} initHeight={40} />
                          <Text style={styles.buttonText}>Papel</Text>
                      </TouchableOpacity>

                      <TouchableOpacity style={styles.button} onPress={ () => this.props.navigation.navigate('Map', { 'file': 'locations.json' }) }>
                          <ResponsiveImage style={{resizeMode: 'stretch'}} source={require('images/icon-plastico.png')} initWidth={19} initHeight={40} />
                          <Text style={styles.buttonText}>Plástico</Text>
                      </TouchableOpacity>
                </View>
                ...
                <View style={styles.subForm}>
                      <TouchableOpacity style={styles.button} onPress={ () => this.props.navigation.navigate('Map', { 'file': 'locations.json' }) }>
                          <ResponsiveImage style={{resizeMode: 'stretch'}} source={require('images/icon-vidro.png')} initWidth={15} initHeight={40} />
                          <Text style={styles.buttonText}>Vidro</Text>
                      </TouchableOpacity>

                      <TouchableOpacity style={styles.button} onPress={ () => this.props.navigation.navigate('Map', { 'file': 'locations.json' }) }>
                          <ResponsiveImage style={{resizeMode: 'stretch'}} source={require('images/icon-metal.png')} initWidth={23} initHeight={40} />
