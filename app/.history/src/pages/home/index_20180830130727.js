...
import { MaterialCommunityIcons, Foundation } from 'icons';
...
class Home extends Component {
    static navigationOptions = {
        header: null,
        swipeEnabled: false,
        tabBarIcon: ({ tintColor }) => <MaterialCommunityIcons name="home-outline" size={(Platform.OS === 'ios') ? 18 : 25} color={tintColor} />
    };
