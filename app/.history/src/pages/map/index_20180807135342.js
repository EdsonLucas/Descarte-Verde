...
export default class Map extends Component {
  ...
  render() {
    ...
    return <View style={styles.container}>
            ...
            <MapboxGL.MapView styleURL={MapboxGL.StyleURL.Street} zoomLevel={16} rotateEnabled={false} showUserLocation={true} centerCoordinate={[-40.2996606, -20.3540692]} style={styles.container} ref={map => (this.mapView = map)}>
