    ...
    return (
        <View style={styles.container}>
            ...
            <View style={styles.topoContainer}>
                  <TouchableOpacity
                      style={{flex: 0.1, alignItems: 'center', justifyContent: 'center', backgroundColor: 'red'}}
                      onPress={() => this.props.navigation.goBack()}
                      >
                      <Ionicons name="ios-arrow-back" size={35} color={colors.text} />
                  </TouchableOpacity>
                <Text style={[styles.topoTitle, {flex: 0.9, marginRight: 100}]}>Pontos de Descarte</Text>
            </View>
