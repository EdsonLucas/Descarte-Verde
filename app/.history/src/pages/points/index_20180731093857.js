...
const points = [
    {
        ...
        backgroundColor: ['#ffffff', '#c4e0e8', '#a6cde1'],
    },

    {
        ...
        backgroundColor: ['#ffffff', '#f7b8be', '#f5848a'],
    },
...
const Pontos = () => (
    <View style={styles.container}>
        {
            points.map(point => (
            <LinearGradient key={point.key} style={styles.subContainer} colors={point.backgroundColor} start={{x: 0.5, y: 0.25}} end={{x: 0, y: 0.75}}>
