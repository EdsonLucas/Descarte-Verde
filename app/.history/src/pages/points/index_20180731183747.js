    ...
    <View style={styles.container}>
    {
        ...
        <View key={point.key} style={[styles.cardContainer, { backgroundColor: point.backgroundColor }]} >
            <View style={styles.imageContainer}>
                <Image style={{postion: 'absolute', resizeMode: 'stretch'}}  source={{uri: 'http://www.cachoeiro.es.gov.br/secretarias/semcos/fotonoticias/c1229_pev.jpg'}} width={100} height={300} />
            </View>
