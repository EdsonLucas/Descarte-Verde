...
import { MaterialCommunityIcons, Feather } from 'react-native-vector-icons/MaterialCommunityIcons';
        ...
        <View>
            <View style={styles.cardContainer} key={cards.key}>
                <View style={styles.infoTitle}>
                    <MaterialCommunityIcons name={cards.icon} size={30} color={cards.colors} />
