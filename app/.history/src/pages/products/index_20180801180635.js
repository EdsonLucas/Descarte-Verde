    ...
    _renderHeader(cards, index, isActive) {
     ...
     _renderContent(cards, index) {
        ...
        <View>
            ...
            {
                texts.map(text => (
                    <View key={index} style={styles.contextText}>
                        <Text>{text.contentText.join("\n")}</Text>
                    </View>                      
                )),

                texts.map(text => (
                    <View key={index} style={styles.contextText2}>
                        <Text>{text.contentText2.join("\n")}</Text>
                    </View>                        
                ))                
            }
            </View>            
