...
const cards = [
    {
        key: '1',
        title: 'Papel',
        text: 'Podem ser reprocessamento por refusão ou remoldagem, onde os plásticos são lavados, fragmentados e triturados, de forma que, uma vez limpos, podem ser fabricados novos produtos a partir deles.',
