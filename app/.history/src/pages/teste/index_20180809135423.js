    ...
    <View style={styles.container}>
    {
        ...
        <View key={point.key} style={[styles.cardContainer, { backgroundColor: point.backgroundColor }]} >
            <View style={styles.imageContainer}>
                <ResposiveImage style={{alignSelf: 'stretch'}}  source={{uri: 'https://i1.wp.com/www.winhelponline.com/blog/wp-content/uploads/2017/12/user.png'}} initWidth={80} initHeight={80} />
            </View>
