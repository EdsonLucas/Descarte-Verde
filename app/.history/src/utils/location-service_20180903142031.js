...
const checkEnableGps = () => {
  const result = LocationServicesDialogBox.checkLocationServicesIsEnabled({
    message: '<h2>Habiltar GPS?</h2>O Descarte Verde precisa alterar a configuração do dispositivo:' +
      "<br/><br/>Habilite o GPS para continuar a usar o Descarte Verde.<br/><br/><a href='#'>Entenda mais</a>",
    ok: 'SIM',
    cancel: 'NÃO',
