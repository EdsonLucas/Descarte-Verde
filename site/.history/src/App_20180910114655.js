            ...
            <div className="container relative z-3">
              <div className="row ">
                <div className="col-lg-6 banner-left text-white ml-lg-auto p-top-100 fadeInRight">
                  ...
                  <p className="ml-lg-3 mr-lg-3 m-top-40 m-bot-30">
                    Encontre com facilidade os pontos de reciclagem mais
                    próximos a você! O Descarte Verde é uma forma
                    inteligente de lidar com o descarte de resíduos,
                    auxiliando você a encontrar os pontos de coleta para
                    reciclagem ou destinação final ambientalmente correta.
                  </p>
            ...
            <div className="container">
              <div className="row">
                <div className="col-md-6 single-service fadeInUp">
                  ...
                  <p class="tjustify">
                    Faça a limpeza dos recicláveis sem receio de estar
                    desperdiçando água, separe em um saco ou caixa de
                    papelão e leve ao ponto de reciclagem mais próximo.
                  </p>
                </div>
                <div className="col-md-6 single-service fadeInUp">
                  <div className="icon">
                  ...
                  <p class="tjustify">
                    {" "}
                    Salvar o planeta é uma atitude complexa e que depende da
                    cooperação de todos. Queremos ajudar nessa luta.{" "}
                  </p>
                </div>
              </div>
              {/* end of row */}
            ...
            <div className="card-group">
              <div className="card bg-phone-at-hands">
                <div className="video">
                  <div className="video-inner fadeInLeft">
                    <button type="button" data-video-id="79LqOdJI4jA" className="play-video-icon js-video-button">
              ...
              <div className="card bg-dark about-video text-white p-top-125 p-bot-100 p-sm-top-80 p-sm-bot-50">
                <div className="promo-heading text-white fadeInRight">
                  ...
                  <p>
                    Cada vez mais, os centros urbanos, com grande
                    crescimento populacional, têm encontrado dificuldades em
                    conseguir locais para instalarem depósitos de lixo.
                    Portanto, a reciclagem apresenta-se como uma solução
                    viável economicamente, além de ser ambientalmente
                    correta e o Descarte Verde quer facilitar ainda mais
                    essa solução.
                  </p>
                </div>
                <ul className="features-list fadeInRight">
                  <li className="single-feature text-white">
                    ...
                    <p>
                      Faça a sua parte, zele pela limpeza dos espaços
                      públicos por meio de pequenos gestos.
                    </p>
                  </li>
                  <li className="single-feature text-white">
                    <div className="feature-icon">
                    ...
                    <p>
                      O Descarte Verde utiliza da tecnologia para auxiliar
                      seus usuários a contribuir com o meio ambiente.
                    </p>
                  </li>
                </ul>
              </div>
                ...
                <div className="col-md-8">
                  <div className="promo-download-texts text-white">
                    ...
                    <h5 className="fadeInUp">
                      Ajude a manter a sua cidade limpa. A iniciativa vem de
                      você!
                    </h5>
