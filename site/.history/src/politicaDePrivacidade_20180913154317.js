...
export default class politicaDePrivacidade extends Component {
  render() {
    return (
      <div className="bg-wine" style={{'overflow-y': 'none'}}>
        ...
        <div className="container">
          <div className="content justify color-white">
            ...
            <p></p>
            <p>O Descarte Verde poderá ainda a seu exclusivo critério e em qualquer tempo, modificar ou desativar o site, bem como limitar, cancelar ou suspender seu uso ou o acesso, assim como o conteúdo destes termos de uso poderão ser alterados a qualquer tempo. Então é responsabilidade do usuário visitar esta página regularmente para garantir que está de acordo com estes termos.</p>
            <p>O usuário se declara ciente de que os conteúdos publicados neste site podem conter imprecisões técnicas ou erros tipográficos, e que em nenhum caso o Descarte Verde se responsabiliza por qualquer dano direto ou indireto decorrente do uso ou impossibilidade do uso das informações disponíveis neste site. Este site pode ainda conter links para outros websites que não são mantidos ou relacionados ao projeto, e dessa forma não somos responsáveis pelo conteúdo destes links.</p>
          </div>
        </div>
